  ...
  <div class="container">
    <div class="site-info row">
      ...
      <div class="col-sm-6 promonote">
        Kaushik | INVENTORY MANAGEMENT SYSTEM <em>(rc1.0)</em>
      </div>
    </div>
    ...
    <hr />
      ...
      <div class="row">
        <div class="col-sm-6 credit">
          <small>
          <a href="#">&copy; 2021-2022 NDS</a> | <span>0915-000-0000</span>
          </small>
        </div>
        <div class="col-sm-6 social">
          <ul class="list-unstyled">
            <li><a href="https://www.facebook.com/istran.net" target="_blank"><i class="fa fa-facebook"></i></a></li>
